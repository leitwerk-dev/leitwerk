...
import {
	forgejoRepoChangeUiLauncher,
	forgejoRepositoryPreparationChecks,
	resolveForgejoGitIdentity,
} from "./launcher.js";
import {
			...
			projects: [
				{
					...
					externalUrl: issueUrl,
					metadata: {
						forgejo: { owner, repo, issueNumber },
...
definition.process.runtime = { ...definition.process.runtime, docker: true };

export const forgejoRepoChangeProcess = definition.process;
