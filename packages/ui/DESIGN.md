...
- **Mapped Items:** Each item of a mapped LLM turn keeps its own card and rail row. Titles append the item label verbatim; metadata and rail detail lead with Item N of M. Items never fold into Earlier updates.
