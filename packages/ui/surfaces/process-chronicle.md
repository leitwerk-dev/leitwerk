...
- Completed and live cards place Show reasoning immediately beside Turn details in the final footer, opening execution Trace in the process inspector. Omit Show reasoning when no details exist. Live reasoning previews, open questions, answer forms, and live stop controls remain above that footer.
